...
for i_NSTATES=2 %1:numel(NSTATES)
    ...
    for i_covregtype=2 % 1:3
        ...
        for i_analysis = 1 % 1:size(analyses,1)
...
title('2D Distances (HMM Transition Probabilities)');
...
% doctor the figure to highlight the highest transitions!!


%
%
%
% so here's the logic to determine which features to select, etc. - take
% inspiration from the figure about the questionnaire answers:
